...
func (mw *JWT) RefreshToken(ctx *gin.Context) (string, time.Time, error) {
	...
	ctx.SetCookie("session", sepToken[1], tt, "/", "", false, true)

	return tokenString, expire, nil
}

func (mw *JWT) CheckTokenExpire(ctx *gin.Context) (jwt.MapClaims, error) {
...
func (mw *JWT) TokenGenerator(data interface{}) (string, time.Time, error) {
...
func (mw *JWT) ParseToken(ctx *gin.Context) (*jwt.Token, error) {
	var token string
	var err error
...
func (mw *JWT) jwtFromHeader(ctx *gin.Context, key string) (string, error) {
...
func (mw *JWT) jwtFromCookie(ctx *gin.Context, key string) (string, error) {
...
func (mw *JWT) jwtFromParam(ctx *gin.Context, key string) (string, error) {
...
func (mw *JWT) jwtFromQuery(ctx *gin.Context, key string) (string, error) {
	token := ctx.Query(key)
